<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <x-nav-dropdown title="Apps" align="right" width="48">
                    @can('view-any', WebVideo\Models\Project::class)
                        <x-dropdown-link href="{{ route('projects.index') }}">
                            Projects
                        </x-dropdown-link>
                    @endcan
                    @can('view-any', WebVideo\Models\Command::class)
                        <x-dropdown-link href="{{ route('commands.index') }}">
                            Commands
                        </x-dropdown-link>
                    @endcan
                    @can('view-any', WebVideo\Models\Argument::class)
                        <x-dropdown-link href="{{ route('arguments.index') }}">
                            Arguments
                        </x-dropdown-link>
                    @endcan
                    @can('view-any', WebVideo\Models\RenderPipeline::class)
                        <x-dropdown-link href="{{ route('render-pipelines.index') }}">
                            Render Pipelines
                        </x-dropdown-link>
                    @endcan
                    @can('view-any', WebVideo\Models\Page::class)
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @can('view-any', WebVideo\Models\Project::class)
                <x-jet-responsive-nav-link href="{{ route('projects.index') }}">
                    Projects
                </x-jet-responsive-nav-link>
            @endcan
            @can('view-any', WebVideo\Models\Command::class)
                <x-jet-responsive-nav-link href="{{ route('commands.index') }}">
                    Commands
                </x-jet-responsive-nav-link>
            @endcan
            @can('view-any', WebVideo\Models\Argument::class)
                <x-jet-responsive-nav-link href="{{ route('arguments.index') }}">
                    Arguments
                </x-jet-responsive-nav-link>
            @endcan
            @can('view-any', WebVideo\Models\RenderPipeline::class)
                <x-jet-responsive-nav-link href="{{ route('render-pipelines.index') }}">
                    Render Pipelines
                </x-jet-responsive-nav-link>
            @endcan
            @can('view-any', WebVideo\Models\Page::class)
                <x-jet-responsive-nav-link href="{{ route('pages.index') }}">
                    Pages
                </x-jet-responsive-nav-link>
            @endcan
            @can('view-any', WebVideo\Models\Section::class)
